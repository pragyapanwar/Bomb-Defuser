...
<body style="background-image: url(Image/ques4.jpg);background-repeat: no-repeat;height:100px;width:1349px;" onload = "startTimer();mainTextScroller()">
    <div class="menu">
        <br>
...
//        }
 ...
 %>
  ...
  <a href="#" style="text-decoration:none">Instructions</a>
   </div>
...
<%
    ...
    String levelsql = "select hint4,hinttime4 from game_info where teamid = "+teamid+"";
    ...
    if(hint==0&&hinttim==0)
    {
        levelsql="update game_info set hinttime4 = "+tim+" where teamid = "+teamid+" ";
...
</br><br>He eventually comes up with the solution of giving them a puzzle so if they succeed they can go free but if they fail they are executed.
</br>
...
<br>If any prisoner can figure out and say to the jailer what colour hat he has on his head all four prisoners go free. If any prisoner suggests an incorrect answer, all four prisoners are executed. The puzzle is to find which prisoner correctly answers the colour of his hat if jailer gives the hats to each person as shown in the figure.
</br>
                </div>
            </td>
        </tr>
