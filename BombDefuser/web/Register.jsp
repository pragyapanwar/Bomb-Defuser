...
<body  OnKeyPress="key(event)"  style="background-image: url(Image/ora3.jpg);background-repeat: no-repeat; background-size: 1600px 780px;">
    <br><br>
...
<form action="registerDBMS.jsp">
  ...
  <div class="container">
      ...
      <input type="text" class="pp" placeholder="Enter Person two's name(optional)" name="p2name" required>
      ...
      <input type="text" class="pp" placeholder="Enter Contact Number(optional)" name="mobileno2" required>
