...
<body style="background-image: url(Image/ques1.jpg);background-repeat: no-repeat;height:100px;width:1349px;" onload = "startTimer();mainTextScroller()">
    <div class="menu">
        <br>
...
<center><div class="level">Level 1</div></center>
 ...
 <%
    ...
    String levelsql = "select hint1,hinttime1 from game_info where teamid = "+teamid+"";
    ...
    if(hint==0&&hinttim==0)
    {
        levelsql="update game_info set hinttime1 = "+tim+" where teamid = "+teamid+" ";
...
<%
    ...
    {
      %>
  <p><a href="javascript:void(0)" style="margin-bottom:-10px;" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><img id="boba" src="Image/img1.png"/></a>
  </p>
...
Clock is ticking..!!
 ...
 The owner of a banana plantation has a camel. He wants to transport his 3000 bananas to 
 the market, which is located after the desert. The distance between his banana plantation 
 and the market is about 1000 kilometer. So he decided to take his camel to carry the bananas. 
 The camel can carry at the maximum of 1000 bananas at a time, and it eats one banana for every 
 kilometer it travels.
What is the most bananas you can bring over to your destination? 
<br>
Add the digits of the answer repeatedly till a single digit is obtained.
