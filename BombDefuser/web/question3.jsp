...
<body style="background-image: url(Image/ques3.jpg);background-repeat: no-repeat;" onload = "startTimer();mainTextScroller()">
    <div class="menu">
        <br>
...
<%
    ...
    String levelsql = "select hint3,hinttime3 from game_info where teamid = "+teamid+"";
    ...
    if(hint==0&&hinttim==0)
    {
        levelsql="update game_info set hinttime3 = "+tim+" where teamid = "+teamid+" ";
