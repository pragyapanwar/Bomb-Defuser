...
<body style="background-image: url(Image/ques2.jpg);background-repeat: no-repeat;height:100px;width:1349px;" onload = "startTimer();mainTextScroller()">
    <div class="menu">
        <br>
...
<%
    ...
    String levelsql = "select hint2,hinttime2 from game_info where teamid = "+teamid+"";
    ...
    if(hint==0&&hinttim==0)
    {
        levelsql="update game_info set hinttime2 = "+tim+" where teamid = "+teamid+" ";
...
<!--  <div id="light" class="white_content">SOME CONTENT HERE...... <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'">Close</a>
  </div>-->
