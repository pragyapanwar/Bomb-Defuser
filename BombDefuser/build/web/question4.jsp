...
#keyboard input[type="text"] 
{
 ...
 .icon-bar {
    ...
    text-align: center;
    margin-top:4%;
    background-color: #002b80; margin-right:0px;
...
<!-- <video id="bgVideo" autoplay loop muted>
  ...
  <video playsinline autoplay muted loop poster="video/fin6.mp4" id="bgvid">
    <source src="video/fin6.webm" type="video/webm">
    <source src="video/fin6.mp4" type="video/mp4">
    </video>
