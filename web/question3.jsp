<%-- 
    Document   : ques3
    Created on : Oct 1, 2016, 11:55:45 AM
    Author     : Neha
--%>
...
<link   href="css/question3QA.css"  rel="stylesheet">
...
<link   href="css/question3.css"  rel="stylesheet">
<script type="text/javascript">
(function() {
   'use strict';
   var i,c;
...
<body style="background-image: url(Image/ques3.jpg);background-repeat: no-repeat;" onload = "startTimer();mainTextScroller();noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">>
    <div class="menu">
        <br>
...
<center><div class="level">Level 3</div></center>
<p><a href="javascript:void(0)" style="margin-bottom:-10px;" onclick="clickinc();document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><img id="boba" src="Image/img1.png"/></a>
    ...
    <div id="light" class="white_content"><br>What if you make three groups and then compare ?
</br>NOTE :- Maximum he can weigh 7 times.<a href="javascript:void(0)" onclick="document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"style="text-decoration:none;font-weight:bold;color:#000000;font-size:30px;position:absolute;right:30px;top:20px">X</a>
  </div>
...
Hurry up!!!!
  ...
  The helpers found 8 inactive bombs at the suspected site. Sid thinks that maybe this could give you a clue to get the passcode for level 3 . 
One of the bombs is defective and weighs less than others. Sid has a balance to measure bombs against each other. Help Sid in this crisis.
As the timer is running fast we need to be quick and find the defective bomb in minimum weighing's.
<br>So how many times should we weigh ?
 ...
 <input style="width:55px;height:35px;margin-left:15px;" id="accept" type="submit" name="enter" value="enter">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <p>Question would give a single digit which itself is the passcode for this level</p>
    </div>
