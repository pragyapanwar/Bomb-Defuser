...
int  l21,l22,l23,l24,l25;
%>        
        <section> <!--for demo wrap-->
<h1>COMPARISON</h1>  
<% 
   try{
   ss = request.getParameter("secid");
////   out.println(ss);
   un =(String) session.getAttribute("tname");
//   String un="team1";
   String sql1,sql2;
   sql1 = "select score1,score2,score3,score4,score5 from game_info where teamid=(select teamid from teams where team_name='"+ss+"')";
   ...
   sql2 = "select score1,score2,score3,score4,score5 from game_info where teamid=(select teamid from teams where team_name='"+un+"')";
...
<table   cellpadding="0" cellspacing="0" border="0">
  <thead>
    <tr>
      <th>CHALLENGE</th>
      <th><% out.println(un); %></th>
      <th><% out.println(ss); %></th>
    </tr>
  </thead>
</table>
</div>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody>
    ...
    <tr>
      <td>LEVEL 1</td>
      <td><% out.println(l21); %></td>
      <td><% out.println(l11); %></td>
    </tr>
    <tr>
      <td>LEVEL 2</td>
      <td><% out.println(l22); %></td>
      
      
      <td><% out.println(l12); %></td>
    </tr>
    <tr>
      <td>LEVEL 3</td>
      <td><% out.println(l23); %></td>
     
      <td><% out.println(l13); %></td>
    </tr>
    <tr>
      <td>LEVEL 4</td>
      <td><% out.println(l24); %></td>
      
      <td><% out.println(l14); %></td>
    </tr>
    <tr>
      <td>LEVEL 5</td>
      <td><% out.println(l25); %></td>
     
      <td><% out.println(l15); %></td>
    </tr>
