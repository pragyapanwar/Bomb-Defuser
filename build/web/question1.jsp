...
<link   href="css/question1.css"  rel="stylesheet" type="text/css">
<link   href="css/question1QA.css"  rel="stylesheet">
...
<link 
href="css/jquerysctipttop.css" rel="stylesheet" type="text/css">

</head>
<body style="background-image: url(Image/ques1.jpg);background-repeat: no-repeat;height:100px;width:1349px;" onload = "startTimer();mainTextScroller();noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
    <div class="menu">
        <br>
...
<center><div class="level">Level 1</div></center>
  <p><a href="javascript:void(0)" style="margin-bottom:-10px;" onclick="clickinc();document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><img id="boba" src="Image/img1.png"/></a>
    ...
    <div id="light" class="white_content"><br>Did you thought of applying greedy approach ? 
</br><br>May be one helper can wait on the other side to bring the torch back.
</br><a href="javascript:void(0)" onclick="document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"style="text-decoration:none;font-weight:bold;color:#000000;font-size:30px;position:absolute;right:30px;top:20px">X</a>
  </div>
...
Clock is ticking..!!
 ...
 Sid contacted the BOMB DEFUSAL HEAD QUARTER. The head quarter received information about a terrorists  camp site, who are suspected to plant the bomb. Head quarter have agreed to send 4 of their helpers to investigate the location. But the path to that location is such that either they have to combat with the enemy or take another route through the bridge. They decided to go through the bridge. All Four helpers need to cross a rickety bridge in minimum time. Unfortunately, they reached the bridge at night and they have only one torch. The bridge is too dangerous to cross without the torch and is only strong enough to support two people at a time. Not all people take the same time to cross the bridge. 
 <br>Times for each person:  1 min, 2 mins, 7 mins and 10 mins.</br>
<br>The shortest time needed for all four to cross the bridge would decode the chip of level 1.
</br>     
        ...
        <tr>
            ...
            <input type="hidden" name="click" id="passclick" value="">
                <div><input id="text" style="text-align:center;font-weight:bold;" type="text" readonly="readonly" name="textbox"></div>
 ...
 <input style="width:35px;height:35px;margin-left:15px;"type="button" value="0">
    <input style="width:55px;height:35px;margin-left:15px;" type="submit" name="enter" value="enter">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <p>Question would give you an integer value on solving it and the sum of those integer values obtained on solving would give the code for this chip. 
</p>
    </div>
