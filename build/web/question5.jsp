...
<body style="  background-image: url(Image/ques5.jpeg);   background-repeat: no-repeat;" onload = "startTimer();mainTextScroller();noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
    <div class="menu">
        <br>
...
<p><a href="javascript:void(0)" style="margin-bottom:-10px;" onclick="clickinc();document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><img id="boba" src="Image/img1.png"/></a>
    ...
    <div id="light" class="white_content">The enemy has set up few hidden camps in between their journey  for dropping their grenades and carrier returns back to pick up the rest of the grenades.  
...
SID gets a secret information from the BOMB DEFUSAL HEAD QUARTER that arms and ammunitions are being transported by the enemies for the destruction of our country. 
The infantry is trying to stop them. In response the enemy force is using the arms against the military. Fortunately all the
 arms wont be transported. But still the infantry was unable to destroy all the arms. The number of arms that the enemy force is able to
 transport would help you decode the chip of level 5.

<br>The enemy wants to transport 3000 grenades to the country which is 1000 kilometer away.  The carrier can carry at the maximum of 1000 grenades at a time and uses one grenade for its defense, at every kilometer it travels.
</br>
What is the maximum number of grenades they can bring over to the country ?
                </div>
            </td>
        </tr>
        <tr>
 ...
 <input style="width:55px;height:35px;margin-left:15px;" id="accept" type="submit" name="enter" value="enter">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
        <p>Question will return an integer.</p>
        <p> Add the digits repeatedly till you get a single digit code.
