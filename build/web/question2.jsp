...
<link   href="css/question2QA.css"  rel="stylesheet">
<link href="css/question2.css" rel="stylesheet" type="text/css">
...
<body style="background-image: url(Image/ques2.jpg);background-repeat: no-repeat;height:100px;width:1349px;" onload = "startTimer();mainTextScroller();noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
    <div class="menu">
        <br>
...
//        }
 ...
 %>
  ...
  %>
    ...
    <center><div class="level">Level 2</div></center>
...
<p><a href="javascript:void(0)" style="margin-bottom:-10px;" onclick="clickinc();document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><img id="boba" src="Image/img1.png"/></a>
    ...
    <div id="light" class="white_content"><br>Ever heard about kadane’s algorithm?</br>
Look for all positive contiguous segments of the array and keep track of maximum sum contiguous segment among all positive segments . 
...
Tik Tok Tik Tok Tik Tok..!!!
 ...
 When the helpers crossed the bridge, they came across the suspected site which the terrorists have just vacated. But in hustle they have left behind a box containing some ammunitions each being marked with an integer. 
<br>The integers  on the ammunitions  are in  the following  order :
</br>
<br>10,-19,15,-9,25,-18,20,-7,12
</br>
The passcode to this level is the sum of group of integers with largest sum (without regrouping and changing the order).
