...
#menu{
    ...
    <body style="background-image: url(Image/bg.jpg);background-repeat: no-repeat; background-size: 1600px 780px;" onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
...
//        }
    ...
    <!--<div class="user">-->
            ...
            <br>Score: <%  out.println(score); %> &nbsp; &nbsp;Rank: <%  out.println(rnk); %>
    <!--</div>-->
            </div></td>
        </tr>
    </table>
  ...
  <table style="margin-left:30px;margin-top:20px;">
      <tr>
          <td class="menus">
              <form method="post" action="InstrTime.jsp" onclick="mytime()">
            ...
            <!--<input type="submit" class="put" value="LEADER BOARD">-->
              <button class="butson btnPush btnLightBlue cut" type="submit" value="Submit" style="font-size: 20px"/>LEADERBOARD</button>
              </div>
              </form>
       ...
       <!--<tr>-->
           <div>
               ...
               <button  class="butson btnPush btnLightBlue dut"  type="submit" style="font-size: 20px" >QUIT GAME</button>
               </form>
           </div>
          </td>
       </tr>
